  ...
  return (
    <div>
      <section className=" text-5xl mb-14 pt-6">
        <h1 className=" font-bold mb-6">Welcome {user && user.name}</h1>
        <p className=" text-slate-500 text-4xl">{user.name}'s Grocery List</p>
      </section>
      ...
      <section className=" w-4/5 m-auto">
        ...
        ) : (<h3>You haven't added any grocery items</h3>)}
      </section>
    </div>
  );
}
